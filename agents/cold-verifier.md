...
- Read any file in `piolium/` other than the single finding draft you were given
...
Record environment type, healthcheck result, each attempt and outcome. Store evidence in `piolium/real-env-evidence/<slug>/`.
...
Write full review to `piolium/adversarial-reviews/<slug>-review.md`.
