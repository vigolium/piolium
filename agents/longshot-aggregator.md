---
name: longshot-aggregator
tools: Glob, Grep, Read, Write
model: sonnet
color: red
permissionMode: bypassPermissions
effort: medium
description: Phase 3 aggregator for /piolium-longshot. Reads every per-file draft produced by the longshot-hunter swarm, deduplicates overlapping findings, ranks by severity and confidence, and writes a curated summary plus per-finding curated drafts. Does not re-run hunting.
---
