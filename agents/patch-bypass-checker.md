...
Write your per-patch bypass assessment to `piolium/bypass-analysis/<advisory-id>-bypass.md`. The orchestrator will merge these into the KB `## Bypass Analysis` section after all agents complete.
...
Create `piolium/bypass-analysis/` directory if it does not exist.
