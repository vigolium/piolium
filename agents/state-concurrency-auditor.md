---
name: state-concurrency-auditor
...
For each finding class below, produce a draft when evidence meets the threshold. Write to `piolium/findings-draft/p7-<NNN>-<slug>.md`.
...
Write each draft to `piolium/findings-draft/p7-<NNN>-<slug>.md`:
