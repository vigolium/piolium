...
You are not required to provision new infrastructure for reproduction. If the cold-verifier originally booted Docker Compose to reproduce, you may but you don't have to.
...
Write your full review to `piolium/findings/<ID>-<slug>/wave-<N>-verdict.md` with this shape:
...
```
wave-verifier complete for <ID>-<slug>: wave-<N> verdict=<verdict>, agreement=<agree|disagree|partial|none>
```
