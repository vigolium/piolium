...
- Phase 15 Task B: all CRITICAL/HIGH findings promoted to `piolium/findings/`
...
Store all evidence under `piolium/real-env-evidence/<finding-slug>/`:

```
piolium/real-env-evidence/<finding-slug>/
